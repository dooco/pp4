...
TEMPLATES_DIR = os.path.join(BASE_DIR, 'templates', './templates', 'allouth',)
...
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:8000', 'https://dooco-pp4.herokuapp.com/', 'https://8000-dooco-pp4-cn40sqc1a56.ws-eu82.gitpod.io']
